  ...
  'targets': [
    {
      ...
      'sources': [
        ...
        'ios/render_view.h',
        'ios/video_channel_gles20.h',
        'ios/video_render_delegate_gles20.h',
        'ios/video_render_gles20.h',
        'ios/video_render_ios_impl.h',
        'ios/render_view.mm',
        'ios/video_channel_gles20.mm',
        'ios/video_render_delegate_gles20.mm',
        'ios/video_render_gles20.mm',

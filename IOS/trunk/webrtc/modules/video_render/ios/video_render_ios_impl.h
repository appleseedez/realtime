...
#ifndef WEBRTC_MODULES_VIDEO_RENDER_MAIN_SOURCE_VIDEO_RENDER_IOS_IMPL_H_
#define WEBRTC_MODULES_VIDEO_RENDER_MAIN_SOURCE_VIDEO_RENDER_IOS_IMPL_H_
...
namespace webrtc {
    ...
    public:
        ...
        VideoRenderIPhoneImpl(const int32_t id,
    ...
    private:
        int32_t _id;
        CriticalSectionWrapper& _renderIPhoneCritsect;
        bool _fullScreen;
        void* _ptrWindow;
        VideoRenderGLES_2_0* _ptrIPhoneRender;
    };
} // namspace webrtc
#endif // WEBRTC_MODULES_VIDEO_RENDER_MAIN_SOURCE_VIDEO_RENDER_IOS_IMPL_H_

...
namespace webrtc {
    ...
    VideoRenderDelegeteGLES_2_0::VideoRenderDelegeteGLES_2_0(int32_t id) :
    _id(id),
    _textureWidth(-1),
    _textureHeight(-1) {
    ...
    int32_t VideoRenderDelegeteGLES_2_0::Setup(int32_t width, int32_t height) {
    ...
    int32_t VideoRenderDelegeteGLES_2_0::SetCoordinates(int32_t zOrder,
                                                        const float left,
                                                        const float top,
                                                        const float right,
                                                        const float bottom) {
    ...
    int32_t VideoRenderDelegeteGLES_2_0::Render(const I420VideoFrame& frameToRender) {
    ...
    GLuint VideoRenderDelegeteGLES_2_0::loadShader(GLenum shaderType,
                                                   const char* pSource) {
    ...
    GLuint VideoRenderDelegeteGLES_2_0::createProgram(const char* pVertexSource,
    ...
    void VideoRenderDelegeteGLES_2_0::SetupTextures(const I420VideoFrame& frameToRender) {
        WEBRTC_TRACE(kTraceDebug, kTraceVideoRenderer, _id,
    ...
    void VideoRenderDelegeteGLES_2_0::UpdateTextures(const
